...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">OpenNg Docs</a>
                </li>
                                        ...
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-OpenNgLibModule-c14175e3dfba53baf7a272bceccad4b6"' :
                                            ...
                                            <li class="link">
                                                <a href="components/OpenNgModalComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">OpenNgModalComponent</a>
                                            </li>
                                        </ul>
                                    </li>
                                <li class="chapter inner">
                                    ...
                                    <ul class="links collapse" ${ isNormalMode ? 'id="directives-links-module-OpenNgLibModule-c14175e3dfba53baf7a272bceccad4b6"' :
                                        ...
                                        <li class="link">
                                            <a href="directives/OpenNgDisallowFilterDirective.html"
                                                data-type="entity-link" data-context="sub-entity" data-context-id="modules">OpenNgDisallowFilterDirective</a>
                                        </li>
                                    </ul>
                                </li>
                            </li>
                    ...
                    <li class="chapter">
                        ...
                        <li class="chapter">
                            ...
                            <ul class="links collapse " ${ isNormalMode ? 'id="directives-links"' : 'id="xs-directives-links"' }>
                                <li class="link">
                                    <a href="directives/OpenNgAllowFilterDirective.html" data-type="entity-link">OpenNgAllowFilterDirective</a>
                                </li>
                                <li class="link">
                                    <a href="directives/OpenNgDisallowFilterDirective.html" data-type="entity-link">OpenNgDisallowFilterDirective</a>
                                </li>
                            </ul>
                        </li>
                        <li class="chapter">
                            ...
                            <ul class="links collapse " ${ isNormalMode ? 'id="injectables-links"' : 'id="xs-injectables-links"' }>
                                <li class="link">
                                    <a href="injectables/OpenNgBackdropService.html" data-type="entity-link">OpenNgBackdropService</a>
                                </li>
                                <li class="link">
                                    <a href="injectables/OpenNgLoadingService.html" data-type="entity-link">OpenNgLoadingService</a>
                                </li>
                            </ul>
                        </li>
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? ' id="interfaces-links"' : 'id="xs-interfaces-links"' }>
                            <li class="link">
                                <a href="interfaces/OpenNgLabelValue.html" data-type="entity-link">OpenNgLabelValue</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/OpenNgNotification.html" data-type="entity-link">OpenNgNotification</a>
                            </li>
                        </ul>
                    </li>
                    <li class="chapter">
